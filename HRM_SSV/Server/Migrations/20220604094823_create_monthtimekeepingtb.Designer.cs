...
namespace Server.Migrations
{
    ...
    [Migration("20220604094823_create_monthtimekeepingtb")]
    partial class create_monthtimekeepingtb
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Server.Entities.Timekeeping", b =>
                {
                    b.HasOne("Server.Entities.MonthTimeKeeping", "MonthTimeKeeping")
                        .WithMany("Timekeepings")
                        .HasForeignKey("MTKId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("MonthTimeKeeping");
                });
